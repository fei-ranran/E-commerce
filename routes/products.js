...
router.post('/:id/comments', authRequired, wrap(productController.addComment));
router.post('/:id/messages', authRequired, wrap(productController.sendMessage));
router.get('/:id/messages', authRequired, wrap(productController.viewMessages));
